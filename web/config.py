...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:xiat_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:xiat_job_results"
  AWS_SNS_GLACIER_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:xiat_glacier_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "xiat_annotations"

  AWS_DYNAMODB_TABLE_INDEX = "user_id_index"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "xiat@mpcs-cc.com"
